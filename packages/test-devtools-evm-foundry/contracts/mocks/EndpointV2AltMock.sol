...
import { EndpointV2Mock } from "./EndpointV2Mock.sol";

contract EndpointV2AltMock is EndpointV2Mock {
    ...
    constructor(uint32 _eid, address _owner, address _altToken) EndpointV2Mock(_eid, _owner) {
